...
1- It queries the tickets collection for the ticketURL to be subscribed (body.to.<ticketUrl>/subscrition), and replies with 200 OK where `reply.body.value = foundTicket.message.body`.
