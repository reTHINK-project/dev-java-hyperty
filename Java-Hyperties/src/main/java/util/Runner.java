...
public class Runner {
  ...
  private static final String WEB_EXAMPLES_JS_DIR = WEB_EXAMPLES_DIR + "";
  private static final String WEB_EXAMPLES_GROOVY_DIR = WEB_EXAMPLES_DIR + "";
  private static final String WEB_EXAMPLES_RUBY_DIR = WEB_EXAMPLES_DIR + "";
