...
public class Run extends AbstractVerticle {
	...
	private void getWalletsInfoSchool(JsonArray wallets) {
	...
	private void getWalletsInfo() {

			Future<JsonArray> transactionsFuture = getAllTransactions();
				...
				if (transactionsResult.succeeded()) {
					...
					for (int j = 0; j < transactions.size(); j++) {
						...
						if (source.equals("checkin")) {
							...
							created++;
						} else if (source.equals("bonus")) {
							bonus++;
						} else if(source.equals("engagedUsers")) {
							engagedUsers++;
						}
					}
					System.out.println("checkin:" + checkin);
					...
					System.out.println("engagedUsers:" + engagedUsers);
					System.out.println("walking distance:" + walkDistance / 1000);
					System.out.println("bikeDistance:" + bikeDistance / 1000);
					System.out.println("user-activity:" + useractivity);
					System.out.println("totalele:" + totalEl);
	...
	Future<JsonArray> getAllTransactions() {

		Future<JsonArray> allTransactions = Future.future();

		mongoClient.find("transactions", new JsonObject(), res -> {
